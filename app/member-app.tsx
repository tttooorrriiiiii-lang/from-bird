...
function AboutPage(){return <div className="about-sky"><section className="about-copy"><span>ABOUT FROM BIRD</span><h1>考えることを、<br/>遊びに変える。</h1><p>FROM BIRDは、<br/>ことば・色・かたちを手がかりに、<br/>社会や文化を見つめ、問いを育てる、<br/>アート＆デザインの実験室です。</p><a href="/projects" onClick={nav("/projects")}>私たちの実験を見る　→</a><small>まだ見ぬ視点へ、<br/>ともに。</small></section><svg className="about-bird-svg" viewBox="0 0 620 680" role="img" aria-label="空を飛ぶ抽象的な鳥"><path className="svg-tail-dark" d="M286 386C206 422 151 503 119 612c91-31 166-94 204-179z"/><path className="svg-tail-light" d="M294 447c-43 54-67 121-72 203 57-48 101-106 118-170z"/><circle className="svg-foot" cx="350" cy="555" r="54"/><path className="svg-body" d="M260 235c87-110 210-154 322-164-26 133-104 247-243 315-44-29-69-78-79-151z"/><path className="svg-wing-light" d="M405 167c54-55 113-83 177-96-12 72-46 137-102 190z"/><path className="svg-head" d="M156 208c52-50 123-52 169-9 30 28 38 73 20 111l-65 78c-35-52-78-92-124-119z"/><path className="svg-beak" d="M156 208 65 255l91 55z"/><circle className="svg-eye" cx="225" cy="228" r="18"/></svg><p className="about-bird-note">飛ぶのは、<br/>考えるためだ。</p><div className="about-orbit" aria-label="FROM BIRDの5つの入口"><b>FROM<br/>BIRD</b><a href="https://kotoba.frombird.com/">ことば</a><span>色</span><span>かたち</span><span>問い</span><span>物語</span></div><svg className="about-horizon" viewBox="0 0 1200 70" preserveAspectRatio="none" aria-hidden="true"><path d="M0 34 C310 70 640 48 1200 22"/></svg></div>}
