...
function AboutPage(){return <div className="about-sky"><section className="about-copy"><span>ABOUT FROM BIRD</span><h1>考えることを、<br/>遊びに変える。</h1><p>FROM BIRDは、<br/>ことば・色・かたちを手がかりに、<br/>社会や文化を見つめ、問いを育てる、<br/>アート＆デザインの実験室です。</p><a href="/projects" onClick={nav("/projects")}>私たちの実験を見る　→</a><small>まだ見ぬ視点へ、<br/>ともに。</small></section><svg className="about-bird-svg" viewBox="0 0 640 680" role="img" aria-label="空を飛ぶ抽象的な鳥"><path className="svg-body" d="M300 350C354 208 472 82 594 34C574 178 477 305 300 350Z"/><path className="svg-wing-light" d="M446 150C493 99 542 62 594 34C585 98 564 157 526 210Z"/><path className="svg-tail-dark" d="M300 350C226 387 143 485 105 610C213 566 278 474 300 350Z"/><path className="svg-tail-light" d="M300 350C331 419 324 520 245 638C249 523 263 434 300 350Z"/><path className="svg-head" d="M300 350C261 304 224 245 154 222C111 208 82 225 69 256C126 287 215 302 300 350Z"/><path className="svg-beak" d="M70 223L4 258L70 294Z"/><circle className="svg-eye" cx="145" cy="244" r="17"/><path className="svg-joint" d="M278 332L315 352L296 385L264 357Z"/></svg><p className="about-bird-note">飛ぶのは、<br/>考えるためだ。</p><div className="about-orbit" aria-label="FROM BIRDの5つの入口"><b>FROM<br/>BIRD</b><a href="https://kotoba.frombird.com/">ことば</a><span>色</span><span>かたち</span><span>問い</span><span>物語</span></div><svg className="about-horizon" viewBox="0 0 1200 70" preserveAspectRatio="none" aria-hidden="true"><path d="M0 34 C310 70 640 48 1200 22"/></svg></div>}
