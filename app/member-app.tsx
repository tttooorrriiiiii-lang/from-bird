...
function AboutPage(){return <div className="about-sky"><section className="about-copy"><span>ABOUT FROM BIRD</span><h1>考えることを、<br/>遊びに変える。</h1><p>FROM BIRDは、<br/>ことば・色・かたちを手がかりに、<br/>社会や文化を見つめ、問いを育てる、<br/>日本のアート＆デザインの<br/>エディトリアルサイトです。</p><a href="/projects" onClick={nav("/projects")}>私たちについて　→</a><small>まだ見ぬ視点へ、<br/>ともに。</small></section><div className="about-big-bird" aria-hidden="true"><span className="ab-tail-top"/><span className="ab-tail-bottom"/><span className="ab-body"/><span className="ab-head"/><span className="ab-wing"/><span className="ab-beak"/><span className="ab-eye"/><span className="ab-foot"/></div><p className="about-bird-note">飛ぶのは、<br/>考えるためだ。</p><div className="about-orbit" aria-label="FROM BIRDの5つの入口"><b>FROM<br/>BIRD</b><a href="https://kotoba.frombird.com/">ことば</a><span>色</span><span>かたち</span><span>問い</span><span>物語</span></div><svg className="about-horizon" viewBox="0 0 1200 70" preserveAspectRatio="none" aria-hidden="true"><path d="M0 34 C310 70 640 48 1200 22"/></svg></div>}
