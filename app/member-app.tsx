...
function AboutPage(){return <div className="about-sky"><section className="about-copy"><span>ABOUT FROM BIRD</span><h1>考えることを、<br/>遊びに変える。</h1><p>FROM BIRDは、<br/>ことば・色・かたちを手がかりに、<br/>社会や文化を見つめ、問いを育てる、<br/>アート＆デザインの実験室です。</p><a href="/projects" onClick={nav("/projects")}>私たちの実験を見る　→</a><small>まだ見ぬ視点へ、<br/>ともに。</small></section><svg className="about-bird-svg" viewBox="0 0 640 680" role="img" aria-label="空を飛ぶ抽象的な鳥"><path className="svg-body" d="M320 335C350 230 430 175 530 158C520 270 440 330 320 335Z"/><path className="svg-wing-light" d="M442 177C472 167 501 161 530 158C526 204 513 239 494 267Z"/><path className="svg-tail-dark" d="M320 335C240 350 170 410 149 511C250 485 305 405 320 335Z"/><path className="svg-tail-light" d="M149 511C155 475 166 447 190 417C195 455 180 490 149 511Z"/><path className="svg-head" d="M320 335C285 285 260 240 215 235C195 233 185 240 183 251L183 290C225 310 270 325 320 335Z"/><path className="svg-beak" d="M183 244L140 267L183 291Z"/><circle className="svg-eye" cx="225" cy="255" r="15"/><path className="svg-orb-neck" d="M320 335L320 390L285 390Z"/><circle className="svg-orb" cx="300" cy="430" r="48"/></svg><p className="about-bird-note">飛ぶのは、<br/>考えるためだ。</p><div className="about-orbit" aria-label="FROM BIRDの5つの入口"><b>FROM<br/>BIRD</b><a href="https://kotoba.frombird.com/">ことば</a><span>色</span><span>かたち</span><span>問い</span><span>物語</span></div><svg className="about-horizon" viewBox="0 0 1200 70" preserveAspectRatio="none" aria-hidden="true"><path d="M0 34 C310 70 640 48 1200 22"/></svg></div>}
